...
dbWriteTable(con, "output_hru", output_hru,overwrite = TRUE, append = TRUE)
dbWriteTable(con, "output_rch", output_rch,overwrite = TRUE, append = TRUE)
dbWriteTable(con, "output_sub", output_sub,overwrite = TRUE, append = TRUE)
dbListTables(con)
